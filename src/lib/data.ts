...
export const hotels: Hotel[] = [
  ...
  { slug: "upper-house", name: "The Upper House", location: "Hong Kong", style: "Zen Urban Elegance",
    description: "Andre Fu's masterpiece — understated luxury with panoramic harbour views.",
    cover: cover("upper-house-hk"), images: get("upper-house-hk"), },
  { slug: "bulgari-milan", name: "Bulgari Hotel Milano", location: "Milan, Italy", style: "Italian Modernist",
    description: "A 18th-century palazzo transformed — dark stone, teak, and black marble.",
    cover: cover("bulgari-milan"), images: get("bulgari-milan"), },
  { slug: "soneva-fushi", name: "Soneva Fushi", location: "Maldives", style: "Barefoot Luxury",
    description: "Castaway chic — open-air villas, sustainable materials, and Indian Ocean infinity.",
    cover: cover("soneva-fushi"), images: get("soneva-fushi"), },
  { slug: "post-ranch-inn", name: "Post Ranch Inn", location: "Big Sur, USA", style: "Organic Architecture",
    description: "Cliffside cabins suspended between Pacific sky and ancient redwoods.",
    cover: cover("post-ranch-inn"), images: get("post-ranch-inn"), },
  { slug: "marina-bay-sands", name: "Marina Bay Sands", location: "Singapore", style: "Futurist Icon",
    description: "Moshe Safdie's gravity-defying sky park — the world's most photographed hotel.",
    cover: cover("marina-bay-sands"), images: get("marina-bay-sands"), },
  { slug: "ritz-paris", name: "Ritz Paris", location: "Paris, France", style: "Belle Époque Grandeur",
    description: "Place Vendôme legend — gilded salons, Michelin stars, and 125 years of history.",
    cover: cover("ritz-paris"), images: get("ritz-paris"), },
  { slug: "the-brando", name: "The Brando", location: "Tetiaroa, French Polynesia", style: "Eco-Luxury Sanctuary",
    description: "Marlon Brando's private atoll — carbon-neutral villas on pristine lagoon.",
    cover: cover("the-brando"), images: get("the-brando"), },
  { slug: "fogo-island-inn", name: "Fogo Island Inn", location: "Newfoundland, Canada", style: "Architectural Minimalism",
    description: "Todd Saunders' masterpiece — a stark geometric form on ancient rocks facing the Atlantic.",
    cover: cover("fogo-island-inn"), images: get("fogo-island-inn"), },
  { slug: "hotel-de-crillon", name: "Hôtel de Crillon", location: "Paris, France", style: "18th-Century Grandeur",
    description: "A rosewood palace on Place de la Concorde — Karl Lagerfeld-designed suites.",
    cover: cover("hotel-de-crillon"), images: get("hotel-de-crillon"), },
  { slug: "the-silo", name: "The Silo Hotel", location: "Cape Town, South Africa", style: "Industrial-Chic Luxury",
    description: "Thomas Heatherwick's grain silo conversion — geometric windows above the V&A Waterfront.",
    cover: cover("the-silo"), images: get("the-silo"), },
  { slug: "giraffe-manor", name: "Giraffe Manor", location: "Nairobi, Kenya", style: "Colonial Safari Elegance",
    description: "1930s manor where Rothschild giraffes join you for breakfast — iconic, whimsical, timeless.",
    cover: cover("giraffe-manor"), images: get("giraffe-manor"), },
  { slug: "adrere-amellal", name: "Adrère Amellal", location: "Siwa, Egypt", style: "Earthen Desert Refuge",
    description: "Hand-built from salt rock and clay — no electricity, just candlelight and Berber beauty.",
    cover: cover("adrere-amellal"), images: get("adrere-amellal"), },
  { slug: "hoshinoya-tokyo", name: "Hoshinoya Tokyo", location: "Tokyo, Japan", style: "Modern Onsen Ryokan",
    description: "A 17-story ryokan — tatami floors, rooftop hot spring, and exquisite kaiseki cuisine.",
    cover: cover("hoshinoya-tokyo"), images: get("hoshinoya-tokyo"), },
  { slug: "borgo-egnazia", name: "Borgo Egnazia", location: "Puglia, Italy", style: "Apulian Village Revival",
    description: "A modern reconstruction of a traditional Puglian borgo — tufo stone, courtyards, and olive groves.",
    cover: cover("borgo-egnazia"), images: get("borgo-egnazia"), },
];
