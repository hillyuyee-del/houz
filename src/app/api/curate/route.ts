...
const CATEGORIES = {
  ...
  "italy-interior": "italian luxury living room bedroom interior design furniture decor",
  "france-interior": "parisian luxury apartment living room bedroom french interior design furniture",
  ...
  "aman-tokyo": "Aman Tokyo luxury hotel suite bedroom bathroom lobby interior design",
  "four-seasons-florence": "Four Seasons Florence luxury palazzo hotel suite bedroom interior design",
  "ace-hotel-kyoto": "Ace Hotel Kyoto boutique luxury hotel room lobby interior design",
  "amangiri": "Amangiri Utah desert luxury hotel suite bedroom interior design",
  ...
  "upper-house-hk": "The Upper House Hong Kong luxury hotel suite bedroom bathroom interior design",
  "bulgari-milan": "Bulgari Hotel Milan luxury suite bedroom interior design furniture",
  "soneva-fushi": "Soneva Fushi Maldives luxury resort villa bedroom bathroom interior",
  "post-ranch-inn": "Post Ranch Inn Big Sur luxury cabin suite bedroom interior design",
  "marina-bay-sands": "Marina Bay Sands Singapore hotel luxury suite bedroom interior design",
  "ritz-paris": "Ritz Paris luxury hotel suite bedroom bathroom interior design furniture",
  // Elements
